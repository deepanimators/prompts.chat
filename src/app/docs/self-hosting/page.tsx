...
export const metadata = {
  title: "Self-Hosting Guide - TUC Prompt",
  description: "Deploy your own TUC Prompt instance with customizable branding, themes, and authentication",
};
  ...
  return (
    <div className="container max-w-4xl py-10">
      ...
      <p className="text-muted-foreground mb-8">
        Deploy your own TUC Prompt instance with customizable branding, themes, and authentication.
      </p>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border p-4 space-y-4">
              <p className="text-muted-foreground">
                TUC Prompt requires PostgreSQL. For a hosted database, we recommend{" "}
                <Link
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>Hide TUC Prompt achievements (GitHub stars, Forbes, etc.)</li>

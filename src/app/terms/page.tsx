...
export const metadata = {
  title: "Terms of Service - TUC Prompt",
  description: "Terms of Service for TUC Prompt",
};
    ...
    <div className="container max-w-3xl py-10">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            By accessing and using TUC Prompt, you agree to be bound by these Terms of Service. 
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            TUC Prompt is an open-source platform for collecting, organizing, and sharing AI prompts. 
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground mt-3">
            ...
            of TUC Prompt. Self-hosted instances operate independently and are not subject to our content moderation policies.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            <Link href="https://github.com/f/TUC Prompt/issues" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">
              GitHub repository
            </Link>{" "}
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            <Link href="https://github.com/f/TUC Prompt" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">
              GitHub
            </Link>. 

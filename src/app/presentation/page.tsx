...
export const metadata = {
  title: "Why TUC Prompt? | Presentation",
  ...
  return (
    <SlideDeck>
      ...
      <div className="flex flex-col items-center justify-center text-center h-full">
        ...
        <SlideTitle className="mb-6">Why TUC Prompt?</SlideTitle>
      ...
      <div className="flex flex-col justify-center h-full">
        ...
        <SlideTitle>The History of TUC Prompt</SlideTitle>
        <SlideContent>
        ...
        <div className="mt-12 p-6 bg-muted/50 rounded-2xl border border-border max-w-2xl">
          <p className="text-lg text-foreground font-mono">
            Awesome ChatGPT Prompts → <SlideHighlight>TUC Prompt</SlideHighlight>
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center h-full">
        ...
        <SlideContent>
          TUC Prompt isn't just for end-users. With features like Agent Skills, Typed Prompts, and API integrations, it's a vital tool for developers building the next generation of AI apps.
        </SlideContent>
      </div>
      ...
      <div className="flex flex-col justify-center h-full">
        ...
        <SlideContent>
          ...
          <br /><br />
          TUC Prompt is <SlideHighlight>100% open-source</SlideHighlight> and deployable to any server or cloud provider. Own your organization's prompt library securely.
        </SlideContent>
      </div>

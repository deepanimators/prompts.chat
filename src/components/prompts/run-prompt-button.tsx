  ...
  switch (platformId) {
    ...
    case "goose": {
      const config = JSON.stringify({
        ...
        instructions: "This is a prompt imported from [**TUC Prompt**](https://tucprompt.vercel.app). Follow the instructions below to complete the task.",
        prompt: promptText,
        activities: [
          "message:This prompt was imported from [**TUC Prompt**](https://tucprompt.vercel.app). Follow the instructions below to complete the task.",
          "Do it now",
